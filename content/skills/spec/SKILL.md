---
name: spec
description: "Create or update the numbered spec, plan, and tasks package. Use when requirements are clear enough for machine readiness. Do not use for discovery, implementation, or bugfixes."
---
...
For unclear requirements that need exploration, use `refine` first.
...
8. Run the automatic readiness checks from
   [readiness and authority boundaries](../refine/references/readiness-and-authority.md).
...
Match the repository's prose. State the point first, use plain language, and
remove filler or unsupported significance claims.
