...
Index of every spec in this repository. Maintain this file when creating a spec,
transitioning its lifecycle, or completing its recorded delivery evidence.
...
| [0009](0009-lazy-workflow-harness/spec.md) | Lazy workflow harness | 7 | Ready | Workflow efficiency audit and user-approved simplification; depends on 0006 and 0008 |
...
| [0002](../docs/decisions/0002-use-assistant-neutral-canonical-content.md) | Use assistant-neutral canonical content with target adapters | Accepted |
